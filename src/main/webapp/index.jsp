...
<form method="post" action="${pageContext.request.contextPath}/login" class="form-signin" >
    <div>
        ...
        <label for="login" class="sr-only">Login</label>
            <input name="login" type="login" id="login" class="form-control" placeholder=<fmt:message key="LOGIN" bundle="${rb}" /> required autofocus pattern="^[a-zA-Z0-9]+$">
        <label for="inputPassword" class="sr-only">Password</label>
            <input name="password" type="password" id="inputPassword" class="form-control" placeholder=<fmt:message key="PASSWORD" bundle="${rb}" /> required autofocus pattern="^[a-zA-Z0-9]+$">
                <div class="mb-4">
                </div>
